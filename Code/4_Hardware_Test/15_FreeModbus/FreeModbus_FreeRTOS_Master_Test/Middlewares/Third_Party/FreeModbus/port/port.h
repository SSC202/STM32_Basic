...
#define SLAVE_RS485_TX_MODE  RS485_Set(1)
#define SLAVE_RS485_RX_MODE  RS485_Set(0)

#define MASTER_RS485_TX_MODE RS485_Set(1)
#define MASTER_RS485_RX_MODE RS485_Set(0)
